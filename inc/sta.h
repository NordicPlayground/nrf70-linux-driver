...
int wifi_nrf_cfg80211_set_qos_map(struct wiphy *wiphy, struct net_device *dev,
...
int wifi_nrf_cfg80211_assoc(struct wiphy *wiphy, struct net_device *dev,
			    struct cfg80211_assoc_request *req);

int wifi_nrf_cfg80211_deauth(struct wiphy *wiphy, struct net_device *dev,
			     struct cfg80211_deauth_request *req);

int wifi_nrf_cfg80211_disassoc(struct wiphy *wiphy, struct net_device *dev,
...
int wifi_nrf_cfg80211_del_key(struct wiphy *wiphy, struct net_device *dev,
